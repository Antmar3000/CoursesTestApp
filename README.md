...
## Запуск приложения
Можно скачать apk по ссылке, но вероятно лучше будет просто скачать код из репозитория и запустить в Android Studio, так лучше будет видна структура проекта.
